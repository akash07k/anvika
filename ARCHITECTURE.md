...
download, or serve models itself or act as an inference engine (ADR 0005). Running models is a
different product with a large platform-specific surface (packaging inference engines, GPU
drivers, weight management), and that surface is a permanent non-goal.
