...
describe('resolveDataDir', () => {
  ...
  // Trust boundary: an unwritable resolved data dir must fail loudly at startup instead of being
  // accepted and crashing later on the first write. Skipped on Windows (a
  ...
  )('throws when the resolved data directory is not writable', () => {
