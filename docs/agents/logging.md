...
This document defines how Anvika logs, for both the server and the client. New
subsystems and use-cases follow it, and every change reviews logging coverage
...
- `info` - use-case outcomes (a conversation loaded, settings saved, a turn finished).
