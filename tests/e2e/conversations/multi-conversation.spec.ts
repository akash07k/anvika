...
test('lists, switches by link, and quick-switches with Alt+Shift+digit', async ({
  ...
  // Guard that the slots are two distinct seeded ids, so the quick-switch assertions below prove
  // navigation changes the URL instead of passing vacuously on a no-op.
